...
def test_and_elim_single_conjunct():
    ...
    assert and_elimination_rule.verify([support], derived)
...
def test_and_elim_multi_conjunct_subset():
    ...
    assert and_elimination_rule.verify([support], subset)
...
def test_and_elim_full_conjunction_same_order():
    ...
    assert and_elimination_rule.verify([support], same)

def test_and_elim_invalid_formula_not_subset():
    P, Q, R = Variable("P"), Variable("Q"), Variable("R")
    support = stmt("1", conj(P, Q))
    not_subset = stmt("2", conj(Q, R), premises=[StepID.from_string("1")])
    assert not and_elimination_rule.verify([support], not_subset)
...
def test_and_elim_wrong_formula_type():
    ...
    assert not and_elimination_rule.verify([support], invalid)
...
def test_and_elim_extra_supports_invalid():
    ...
    assert not and_elimination_rule.verify([support, extra], derived)
...
def test_or_elimination_valid():
    ...
    assert or_elimination_rule.verify([disj, case1, case2], result)
...
def test_or_elimination_wrong_conclusion():
    ...
    assert not or_elimination_rule.verify([disj, case1, case2], result)
...
def test_or_elimination_too_few_supports():
    ...
    assert not or_elimination_rule.verify([disj, case1], result)
...
def test_or_elimination_three_disjuncts():
    ...
    assert or_elimination_rule.verify([disj_stmt, sp1, sp2, sp3], conclusion)
...
def test_or_elimination_three_disjuncts_one_missing():
    ...
    assert not or_elimination_rule.verify([disj_stmt, sp1, sp2], conclusion)
...
def test_or_elimination_three_disjuncts_different_conclusions():
    ...
    assert not or_elimination_rule.verify([disj_stmt, sp1, sp2, sp3], conclusion)
...
def test_double_negation_invalid_formula():
    ...
    assert not not_elimination_rule.verify([support], conclusion)
...
def test_double_negation_wrong_number_of_supports():
    ...
    assert not not_elimination_rule.verify([support, extra], conclusion)
...
def test_bottom_elim_valid_any_conclusion():
    ...
    assert bottom_elimination_rule.verify([support], conclusion)
...
def test_bottom_elim_invalid_support_not_bottom():
    ...
    assert not bottom_elimination_rule.verify([support], conclusion)
...
def test_bottom_elim_invalid_support_count():
    ...
    assert not bottom_elimination_rule.verify([support1, support2], conclusion)
...
def test_conditional_elim_valid_order1():
    ...
    assert conditional_elimination_rule.verify([impl, premise], conclusion)
...
def test_conditional_elim_valid_order2():
    ...
    assert conditional_elimination_rule.verify([premise, impl], conclusion)
...
def test_conditional_elim_invalid_mismatched_antecedent():
    ...
    premise = stmt("2", P)
    conclusion = stmt("3", Q, premises=[StepID.from_string("1"), StepID.from_string("2")])
    assert not conditional_elimination_rule.verify([impl, premise], conclusion)
...
def test_conditional_elim_invalid_wrong_number_of_supports():
    ...
    impl = stmt("1", Implies(P, Q))
    conclusion = stmt("2", Q, premises=[StepID.from_string("1")])
    assert not conditional_elimination_rule.verify([impl], conclusion)
...
def test_biconditional_elim_forward():
    ...
    support = stmt("2", P)
    conclusion = stmt("3", Q, premises=[StepID.from_string("1"), StepID.from_string("2")])
    assert biconditional_elimination_rule.verify([bicond, support], conclusion)
...
def test_biconditional_elim_support_order_swapped():
    ...
    conclusion = stmt("3", Q, premises=[StepID.from_string("1"), StepID.from_string("2")])
    assert biconditional_elimination_rule.verify([support, bicond], conclusion)
...
def test_biconditional_elim_invalid_mismatch():
    ...
    support = stmt("2", R)
    conclusion = stmt("3", Q, premises=[StepID.from_string("1"), StepID.from_string("2")])
    assert not biconditional_elimination_rule.verify([bicond, support], conclusion)
...
def test_biconditional_elim_invalid_support_count():
    ...
    bicond = stmt("1", Iff(P, Q))
    conclusion = stmt("2", Q, premises=[StepID.from_string("1")])
    assert not biconditional_elimination_rule.verify([bicond], conclusion)